...
#     print(np.array(2 * epsilon).reshape(-1, 1))
#     print(parameters)
...
#     return 5
    ...
    for i in range(num_parameters):
        ...
        ### START CODE HERE ### (approx. 1 line)
#         gradapprox[i] = np.true_divide(np.subtract(J_plus[i], J_minus[i]), np.array(2 * epsilon).reshape(-1, 1))
#         gradapprox[i] = np.divide(np.subtract(J_plus[i], J_minus[i]), np.array(2 * epsilon).reshape(-1, 1))
